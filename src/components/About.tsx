const About: React.FC = () => {
    ...
    return (
        <section className="pb-5 pt-3 pt-lg-5 m-4 m-md-5" id="about">
            <h2 className="display-5 text-center mb-3 mb-lg-4">About me</h2>
            ...
            <div className="row align-items-center gap-5 py-lg-5">
                ...
                <div className="col-lg-5">
                    <div className="about-container mx-auto rounded shadow-lg p-3 bg-white">
                        <div className="d-flex justify-content-center">
                        ...
                        <p className="text-center mb-0">FullStack Developer</p>
                    </div>

                    <div className="about-container mx-auto rounded shadow-lg p-3 mt-3 bg-white">
                        <div className="d-flex justify-content-center">
                            <img className="img-fluid icon" src="/unab.svg" alt="imagen ícono" />
                        </div>
                        <h3 className="text-center fs-5 mt-2">Universidad Andrés Bello</h3>
                        <p className="text-center mb-0">Biotechnology Engineer</p>
                    </div>
                </div>
